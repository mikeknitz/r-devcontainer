...
rm -rf .git
mv src/common-utils build-scripts/pulled-scripts/.
mv src/git build-scripts/pulled-scripts/.
rmdir src
...
git checkout "${COMMIT_TO_PULL}"
rm -rf .git
mv src/tmux build-scripts/pulled-scripts/.
mv src/neovim build-scripts/pulled-scripts/.
rmdir src
...
git checkout "${COMMIT_TO_PULL}"
rm -rf .git
mv src/neofetch build-scripts/pulled-scripts/.
rmdir src
