...
``` bash
cd builds/r-devcontainer-r441-amd64-2024-09-18
```
...
``` bash
docker build -t <docker-hub-username>/r-devcontainer:r441-amd64-2024-09-18 .
```

Push to Docker Hub

``` bash
docker push <docker-hub-username>/r-devcontainer:r441-amd64-2024-09-18
```
