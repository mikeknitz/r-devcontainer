# Bioconductor mirror
options(BioC_mirror = "https://packagemanager.posit.co/bioconductor/2024-10-25")
options(BIOCONDUCTOR_CONFIG_FILE = "https://packagemanager.posit.co/bioconductor/2024-10-25/config.yaml")

# CRAN mirror
options(repos = c(CRAN = "https://packagemanager.posit.co/cran/__linux__/jammy/2024-10-25"))
